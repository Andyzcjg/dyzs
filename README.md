...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https%3A%2F%2Fgithub.com%2Fmasterleotaiwan%2Fsiaopai-h01)
...
`UUID` 默认为 `9a9e1b88-de01-11ec-9d64-0242ac120002` 你也可以在部署时自由修改（建议修改）。
...
addEventListener(
      "fetch",event => {
         ...
         url.hostname="HEROKU地址，例如 masterleotaiwan.herokuapp.com";
...
```
vless://9a9e1b88-de01-11ec-9d64-0242ac120002@你的自选ip:443?encryption=none&security=tls&sni=你的HEROKU地址或CF反代地址&type=ws&host=你的HEROKU地址或CF反代地址#heroku
